  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-8 max-w-4xl">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        {blog.imageFile && (
          <img src={blog.imageFile} alt={blog.title} className="w-full object-cover" style={{ maxHeight: "500px" }} />
        )}
          ...
          <div key={blog._id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col h-full">
            {blog.imageFile && (
              <div className="w-full h-48 overflow-hidden">
                <img src={blog.imageFile} alt={blog.title} className="w-full h-full object-cover" />
              </div>
            )}
