...
// const SingleBlogView = ({ blog, onBack }) => {
//   return (
...
//   const { data: searchBlogs } = useQuery(queryKey, () =>
...
// Define an interface for your Blog data structure
// interface Blog {
//   _id: string;
//   title: string;
//   description: string;
...
//   createdAt: string; // Assuming createdAt is always present
//   textEditor: string; // Assuming textEditor is always present
// }
