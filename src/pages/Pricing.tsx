...
import WhatsAppLinkButtonPricing from "@/components/ContactPricing";
                ...
                <div className="flex-grow flex flex-col">
                  {plan.isPopular && (
                    <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2">
                      <span className="bg-blue-500 text-white text-xs font-bold px-4 py-1 rounded-full uppercase">
                        Most Popular
                      </span>
                    </div>
                  )}
                  <h3 className="text-lg text-blue-600 underline tracking-wide md:text-2xl lg:text-2xl font-extrabold">
                    {plan.name}
                  </h3>
                  <p className="mt-1 text-sm md:text-lg lg:text-lg text-gray-500 min-h-[40px]">
                    {plan.description}
                  </p>
                  ...
                  <div className="flex-grow">
                    {
                      <ul className="mt-8 space-y-4">
                        {plan.features.map((feature, fIndex) => (
                          <li
                            key={fIndex}
                            className="flex items-center text-sm tracking-tight -mt-8 md:text-lg md:mt-3"
                          >
                            {feature.included ? (
                  ...
                  <div className="mt-8">
                    {
                      <>
                        <Link
                          to="#contact-form"
                          className={`block w-full text-center font-semibold py-3 rounded-lg transition-colors ${plan.isPopular ? "bg-blue-500 text-white hover:bg-blue-600" : "bg-blue-400 text-white hover:bg-blue-500"}`}
                        >
                          Get Started
                        </Link>
                        <div className="">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 max-w-7xl mx-auto">
            ...
            >
              <form
                onSubmit={onSubmits}
                className="bg-gray-100 p-8 rounded-2xl space-y-6"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 bg-white rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full p-3 bg-white rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"
                ...
                <div>
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-colors duration-300 disabled:bg-gray-400 disabled:cursor-not-allowed"
                  >
