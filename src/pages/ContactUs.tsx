    ...
    <main className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 flex flex-col lg:flex-row items-center justify-center relative z-10 gap-12 lg:gap-16">
        ...
        */}
        ...
        <form onSubmit={onSubmits} className="w-full lg:w-7/12 bg-white p-6 sm:p-8 lg:p-10 rounded-2xl shadow-2xl">
           {/* Mobile-only Header */}
          ...
          <div className="space-y-6">
            ...
            <Button type="submit" disabled={isLoading} className="w-full py-3 text-base font-semibold bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all duration-300 shadow-md hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed">
